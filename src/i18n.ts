...
const resources = {
  de: {
    translation: {
      ...
      cropImageDescription: "Ziehe und zoome, um den Bildausschnitt zu wählen. Wir erzeugen ein quadratisches Bild.",
      zoom: "Zoom",
      dragToPosition: "Zum Positionieren ziehen",
      confirmCrop: "Zuschneiden bestätigen",
      cropHintUrl: "Hinweis: Für externe Bild-URLs wird kein Zuschnitt erzwungen. Bitte verwende quadratische Bilder für beste Ergebnisse.",
  ...
  en: {
    translation: {
      ...
      cropImageDescription: "Drag and zoom to position the frame. We'll produce a square image.",
      zoom: "Zoom",
      dragToPosition: "Drag to position",
      confirmCrop: "Confirm Crop",
      cropHintUrl: "Note: External image URLs are not auto-cropped. Please use square images for best results.",
  ...
  es: {
    translation: {
      ...
      cropImageDescription: "Arrastra y haz zoom para posicionar el encuadre. Se generará una imagen cuadrada.",
      zoom: "Zoom",
      dragToPosition: "Arrastra para posicionar",
      confirmCrop: "Confirmar recorte",
      cropHintUrl: "Nota: Las URLs externas de imágenes no se recortan automáticamente. Usa imágenes cuadradas para mejores resultados.",
  ...
  fr: {
    translation: {
      ...
      cropImageDescription: "Glissez et zoomez pour positionner le cadre. Une image carrée sera produite.",
      zoom: "Zoom",
      dragToPosition: "Glisser pour positionner",
      confirmCrop: "Confirmer le recadrage",
      cropHintUrl: "Remarque : Les URLs d'images externes ne sont pas recadrées automatiquement. Utilisez des images carrées pour de meilleurs résultats.",
